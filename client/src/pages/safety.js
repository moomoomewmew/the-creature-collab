    ...
    <div className="safety-info">
      ...
      <div className="guidelines-list">
        ...
        <div className="rules">
          ...
          <p className="guideline-list-info">
            Go with a friend, or let a roommate, relative, or other trusted
            human know where you are going, and when you plan to return. Arrange
        ...
        <div className="rules">
          ...
          <p className="guideline-list-info">
            Be kind and respectful in all your interactions with other
            characters, both online and in-person. Creature Collab does not
            tolerate bullying, harrassment, trolling, or bigotry of any kinds.
            Creature Collab maintains a zero-tolerance policy against
            discrimination in all forms. Violators will be exiled from Creature
            Collab. Please report any incidents of harm and/or violence of these
            kinds to an admin.
          </p>
          <img
        ...
        <div className="rules">
          ...
          <p className="guideline-list-info">
            When planning events, please take into consideration the diverse
            needs of different users to keep your events open to all. For
            example, is the venue of your in-person event accessible for
            wheelchair users? What about options for social distancing? Do you
            have closed captions available for your online event? These are just
            some of the ways you can help us make Creature Collab enjoyable for
            all! Furthermore, if you have suggestions on making Creature Collab
            more accessible, please be sure to let an admin know!
          </p>
          <img
        ...
        <div className="rules">
          ...
          <p className="guideline-list-info">
            ...
            welcoming, and refrain from posting content depicting nudity or
            sexual material, graphic violence and/or illicit activities. Members
            agree to our terms of use upon registering for an account. Violation
            of these terms will result in account deactivation and banishment
            from the Creature Collab realm.
          </p>
          <img
            className="fun"
